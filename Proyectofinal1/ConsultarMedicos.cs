...
{
    public partial class ConsultarMedicos : Form
    {
        ...
        private void Button1_Click_1(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = obj.LlenarGridBuscarMed(nombre);
            textBox1.Text = "";
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = obj.LlenarGridBuscarMedCorreo(exequatur);
            textBox2.Text = "";
        }
